...
public class ErrorMessage {
	...
	static {
		...
		commonMap.put(-58, "请重新提交");
		commonMap.put(-57, "该用户未授权，请确定授权后再确认提现");
		commonMap.put(-56, "请设置提现方式");
		commonMap.put(-55,"已评价");
		...
		commonMap.put(-9000,"注册失败!");
		commonMap.put(-9001,"操作成功");
		commonMap.put(-9002,"全国无法删除");
		commonMap.put(-9003,"参数为空");
		commonMap.put(-9004,"订单数据不存在,请检查订单号码");
		commonMap.put(-9005,"没有达到最低起送价格,无法下单");
	}
