...
public class JsonRet<T> implements Serializable {
    ...
    public static <T> JsonRet<T> buildRet(int errorCode,String message){
        JsonRet<T> ret = new JsonRet<T>();
        ret.setStatus(errorCode);
        ret.setMessage(message);
        logger.info(JSON.toJSONString(ret));
    ...
    public static <T> JsonRet<T> message(int code,String message,T data){
        JsonRet<T> ret = new JsonRet<T>();
        ret.setStatus(code);
        ret.setMessage(message);
        ret.setData(data);
    ...
    public static <T> JsonRet<T> message(int code,String message){
        JsonRet<T> ret = new JsonRet<T>();
        ret.setStatus(code);
        ret.setMessage(message);
        logger.info(JSON.toJSONString(ret));
    ...
    public static <T> JsonRet<T> message(int code){
        String message = ErrorMessage.getCommonError(code);
        JsonRet<T> ret = new JsonRet<T>();
        ret.setStatus(code);
        ret.setMessage(message);
        ret.setData(null);
